    ...
    <div className="flex flex-col gap-2 text-foreground" data-testid="ask-user-question-form">
      <div className="flex items-center gap-2 text-xs text-muted-foreground">
        <span data-testid="ask-user-question-progress">
          {t("permissions.approval.askUser.progress", {
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            ...
            <textarea
              rows={1}
              placeholder={t("permissions.approval.askUser.customPlaceholder", {
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          {t("permissions.approval.askUser.prev", { defaultValue: "Prev" })}
        </Button>
        {!isLast && (
          <Button
            size="sm"
          ...
          >
            {t("permissions.approval.askUser.next", { defaultValue: "Next" })}
        ...
        {isLast && (
          ...
          >
            ...
            {t("permissions.approval.askUser.submit", { defaultValue: "Submit" })}
          </Button>
        )}
