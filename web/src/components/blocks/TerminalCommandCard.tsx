  ...
  const trigger = (
    ...
    >
      ...
      <span className="min-w-0 flex-1 truncate font-mono text-muted-foreground/80">
        {hasOutput
          ? t("permissions.cards.terminal.output", { defaultValue: "output" })
          : t("permissions.cards.terminal.noOutput", { defaultValue: "(no output)" })}
      </span>
      {hasOutput && (
            ...
            <CodeBlockHeader>
              <CodeBlockTitle className="min-w-0">
                <span className="truncate font-medium uppercase tracking-wide">
                  {t("permissions.cards.terminal.stdout", { defaultValue: "stdout" })}
                </span>
              </CodeBlockTitle>
            </CodeBlockHeader>
          </CodeBlock>
        ...
        {hasStderr && (
          <CodeBlock code={stderr as string} language="bash">
            <CodeBlockHeader>
              <CodeBlockTitle className="min-w-0">
                <span className="truncate font-medium uppercase tracking-wide">
                  {t("permissions.cards.terminal.stderr", { defaultValue: "stderr" })}
                </span>
              </CodeBlockTitle>
            </CodeBlockHeader>
          </CodeBlock>
